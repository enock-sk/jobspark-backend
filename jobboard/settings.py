...
# ALLOWED_HOSTS dynamically set by Render or from .env
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'corsheaders',
    'knox',  # Replaces rest_framework.authtoken for secure token auth
    'jobs',
]
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'knox.auth.TokenAuthentication',  # Use Knox for token auth
    ],
...
# Knox settings
REST_KNOX = {
    'TOKEN_TTL': None,  # Tokens never expire by default (customize as needed)
    'AUTO_REFRESH': True,  # Refresh tokens automatically
}
...
DATABASES = {
    'default': dj_database_url.config(
        ...
        conn_max_age=600  # Improve performance on Render
    )
}
